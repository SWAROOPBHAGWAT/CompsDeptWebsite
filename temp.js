          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 offcanvas-nav">
              ...
              <li class="nav-item dropdown text-center">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <li>
                      <a class="dropdown-item" href="/faculty/minor_grants.html">Minor Grants</a>
                      </li>
                      <li>
                      <a class="dropdown-item" href="/faculty/research_publications.html">Research Publications</a>
                      </li>
                    </ul>
                  </li>
                </ul>
              ...
              <li class="nav-item dropdown text-center">
                ...
                <li><a class="dropdown-item" href="/cocurricular/clubs.html">Alumni Interaction</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown text-center">
                <a
